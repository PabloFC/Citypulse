...
// Lista de las 75 ciudades más turísticas y visitadas de España
const popularCities = [
      ...
      <form onSubmit={handleSubmit}>
        <div className="relative">
          ...
          <input
            ...
            placeholder="Buscar ciudad... (ej: Madrid, Barcelona, Valencia)"
